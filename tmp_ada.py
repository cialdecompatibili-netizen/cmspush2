...
corpo = """## Una mente matematica in un salotto vittoriano
...
pubblica_articolo(
    titolo="Ada Lovelace: la donna che immagino' il computer un secolo prima",
    categoria="tecnica",
    excerpt="La storia di Ada Lovelace, la prima programmatrice della storia: un algoritmo scritto nel 1843 per una macchina mai costruita, e l'intuizione che ha anticipato l'informatica moderna.",
    corpo=corpo,
    image="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Ada_Lovelace.jpg/600px-Ada_Lovelace.jpg",
    image_caption="Ritratto di Ada Lovelace, Margaret Sarah Carpenter, 1836",
)
